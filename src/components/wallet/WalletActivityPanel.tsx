      ...
      <CardContent>
        <Tabs defaultValue="transactions" className="w-full">
          <TabsList className="mb-4 flex h-auto w-full flex-col gap-1 p-1 sm:grid sm:grid-cols-2 lg:grid-cols-4">
            <TabsTrigger value="transactions" className="w-full justify-center gap-1.5 px-2 py-2.5 text-xs sm:text-sm">
              <ReceiptText className="hidden h-4 w-4 sm:block" aria-hidden />
              {t("wallet.tabTransactions")}
            </TabsTrigger>
            <TabsTrigger value="requests" className="w-full justify-center gap-1.5 px-2 py-2.5 text-xs sm:text-sm">
              <ClipboardList className="hidden h-4 w-4 sm:block" aria-hidden />
              {t("wallet.tabRequests")}
            </TabsTrigger>
            <TabsTrigger value="betting" className="w-full justify-center gap-1.5 px-2 py-2.5 text-xs sm:text-sm">
              <History className="hidden h-4 w-4 sm:block" aria-hidden />
              {t("wallet.tabBetting")}
            </TabsTrigger>
            <TabsTrigger value="affiliate" className="w-full justify-center gap-1.5 px-2 py-2.5 text-xs sm:text-sm">
